...
These are all the alpha scale rarefaction curves. We are usually interested in the average sample Therefore let's take the mean of these curves. Also, lets put them in the in the same graph as the gamma scale to see how they compare.
...
While sample size is surely related to the distance to the asymptote of the IBR, it is only part of the story, because it is always relative. The asymptote or more generally the slope at any point along the IBR curve relates to something called *sample completeness*. This differs from sample size because in that it depends on the species pool of the community that you are sampling.
