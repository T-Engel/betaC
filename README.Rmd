...
We can also examine the entire scaling relationship of the nonrandom component in beta-diversity. To do that we calculate beta_Sn for every N and the corresponding coverages at the gamma scale. This can be done using `beta_C_curve`. 
